...
function loadServiceAccount() {
  try {
    ...
    const candidates = [
      ...
      '/root/mizan/secrets/firebase-service-account.json',
      '/root/mizan/firebase-service-account.json',
      '/opt/mizanmod-full/secrets/firebase-service-account.json',
      '/opt/mizanmod-full/firebase-service-account.json',
